...
import { postTVDiscussion } from "../../api/api";
import { Alert } from "@mui/material";

const NewTVDiscussion = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const submitResponse = await postTVDiscussion(formData);
  ...
  return (
    <div className="p-10 bg-[#303461] m-44 mx-32 rounded-3xl justify-center items-center">
      ...
      <h1 className="text-6xl font-bold mb-10">New TV Discussion</h1>
      {isSuccess ? (
...
export default NewTVDiscussion;
